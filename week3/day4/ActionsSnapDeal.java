...
public class ActionsSnapDeal {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
        ...
        List<WebElement> prices = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath("//span[@class='lfloat product-price']")));
        ...
        js.executeScript("window.scrollTo(0, document.body.scrollHeight);");
        Thread.sleep(5000);
        List<WebElement> newPrices = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath("//span[@class='lfloat product-price']")));
       ...
       //Filter By Cost 500 to 700
        ...
        //Verify the filtered products count
        String filteredProductCount = driver.findElement(By.xpath("//a[text()=' White & Blue']/following-sibling::span")).getText(); 
