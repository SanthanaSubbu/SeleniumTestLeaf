...
//
			...
			//To retrieve Train Names Column
			List<WebElement> entireCol = driver.findElements(By.xpath("//span[text()='Customer Analytics Table']/following::table[2]/tbody/tr/td[2]"));

			for (int i = 0; i < entireCol.size(); i++) {
			String text = entireCol.get(i).getText();
			System.out.println(text);
